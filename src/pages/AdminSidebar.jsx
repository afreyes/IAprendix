        ...
        <ul className="flex-1">
          ...
          <li>
            ...
            >
              ...
              <RiArrowRightSLine
                className={`mt-1 ${
                  showSubmenuCursos && "rotate-90"
                } transition-transform`}
              />
            </button>
            <ul
              className={`ml-8 ${
                showSubmenuCursos ? "h-auto" : "h-0"
              } overflow-y-hidden transition-all`}
            >
              <li className="my-2">
                <Link
                  to="/courses/CoursesAdd"
                  className="py-2 px-4 border-l border-gray-600 block relative before:w-3 before:h-3 before:absolute before:bg-primary before:rounded-full before:-left-4 before:top-1/2 before:-translate-y-1/2 hover:text-white transition-colors"
                >
                  Agregar Curso
                </Link>
              </li>
              <li className="my-2">
                <Link
                  ...
                  className="py-2 px-4 border-l border-gray-600 block relative before:w-3 before:h-3 before:absolute before:bg-gray-600 before:rounded-full before:-left-4 before:top-1/2 before:-translate-y-1/2 hover:text-white transition-colors"
                >
                  Editar Curso
                </Link>
              </li>
          ...
          <li>
            ...
            >
              <span className="flex items-center gap-4">
                <RiSettings3Line className="text-primary" /> Registrar
                Estudiantes
              </span>
              <RiArrowRightSLine
                className={`mt-1 ${
                  showSubmenuEstudiantes && "rotate-90"
                } transition-transform`}
              />
            </button>
            <ul
              className={`ml-8 ${
                showSubmenuEstudiantes ? "h-auto" : "h-0"
              } overflow-y-hidden transition-all`}
            >
              <li className="my-2">
                <Link
